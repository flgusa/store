...
namespace Store.Tests
{
    public class OrderTests
    {
        ...
        [Fact]
        public void TotalCount_WithNonEmptyItems_CalcultesTotalCount()
        {
        ...
        [Fact]
        public void TotalPrice_WithNonEmptyItems_CalcultesTotalPrice()
        {
            var order = new Order(1, new[]
            {
                new OrderItem(1, 3, 10m),
        ...
        [Fact]
        public void GetItem_WithNoneExistingItem_ThrowInvalidOperationException()
        {
            var order = new Order(1, new[]
            {
                new OrderItem(1, 3, 10m),
        ...
        [Fact]
        public void RemoveItem_WithNoneExistingItem_ThrowInvalidOperationException()
        {
            var order = new Order(1, new[]
            {
                new OrderItem(1, 3, 10m),
